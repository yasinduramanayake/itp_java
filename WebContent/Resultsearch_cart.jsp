...
<% ArrayList<cart> searching_m =(ArrayList<cart>)request.getAttribute("Arrayrane"); %>


<h2 align="center"><font><strong>Cart history</strong></font></h2>
...
<td><%=searching_m.get(i).getColours()%></td>
<td><%=searching_m.get(i).getQuantity()%></td>
<td><%=searching_m.get(i).getCus_id()%></td>
<td><%=searching_m.get(i).getCart_id()%></td>
