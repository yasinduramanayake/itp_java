...
<% ArrayList<Pricing_details> searching =(ArrayList<Pricing_details>)request.getAttribute("Array3"); %>


<h2 align="center" style="color:white;"><font><strong>Pantey & Kitchen Furniture properties</strong></font></h2>
<center>
