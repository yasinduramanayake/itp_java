...
<input type="search" name="searchhousep" id="myInput7" placeholder="Search.." ><input type="submit" value="search"></form></div></li>
<li>
...
<center><h1 style = "font-family: Arial, Helvetica, sans-serif;
				        color:white;
				        font-size: 2.0em;
				        text-shadow: 3px 2px #black;">Steel and stsinless stell fabricate workes</h1></center>
				        <center>
...
preparedStatement.setString(1,"STEEL AND STAINLESS STELL FABRICATE WORKES");
...
<td><form  method="post" action="preupdated_deigning_projects">
            ...
            <input type="number"  step="1"  name="proect_ID" id="Type"  value="<%=res.getString("proect_ID")%>" required hidden>
						...
						<input type="text"  hidden name="Description"  id ="Description" value="<%=res.getString("Description")%>"  required >
			             <input type="number"  step="1" hidden name="linkproject"   value="7"  required >
			...
			<input type="number"  step="1" hidden name="linkproject" type ="text"  value="7"  required >
