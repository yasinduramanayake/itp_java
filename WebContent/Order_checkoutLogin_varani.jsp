...
<div class="split right">
 ...
 <br><br>
    ...
    <form  method="post" action="Order_checkout_login_servelet">
                        <div class="container">
  ...
  border-radius: 12px;"><br>
      ...
      <input type="number" step="0.01"  hidden value="<%=request.getAttribute("varaniprice")%>" name="pricev" required>
      
       <label for="quantity"><b></b></label>
      <input type="number" step="1"  hidden  value="<%=request.getAttribute("varaniquantity")%>" name="quantityv" required>
      
       <label for="email"><b></b></label>
      <input type="email"  name="color12v" value="<%=request.getAttribute("varaniEmail")%>" hidden required>
      
        
      <button type="submit">Login</button>
      
    <div class="psw"><a href="Registeration.jsp"><h4 style="color:black;background-color:#f1f1f1;">Dont't have an Account? Register Now!</h2></a></div>
