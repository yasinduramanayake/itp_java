...
<li><div class="search"><form method="post" class="modal-content animate" action="searchcart"><input type="search" name="search" placeholder="Search.." ><input type="submit" value="search"></form></div>
</form></div></li>
<li>
...
%>
<center>
<h2 id="head2" class="head2" style="color:white;" align="center"><font><strong><center>Cart Items</center></strong></font></h2>
</center>
...
String  sql1= "select * from shopping_cart";
...
<td>
  ...
  <form  action="UPDATE_cart" method="post">
      ...
      <br><input type="number" step ="1" name="Quantity"  value="<%=res.getInt("quantity") %>" required>  
       ...
       <br><input type="number" step ="1 "  name = "cusID" value="<%=res.getInt("Cus_ID") %>" required>
      
      <br><input type="number" step ="1 "  name = "CartID" value="<%=res.getInt("Cart_ID") %>" required>
      <input type="number" step="1"  hidden required name="validate" value="1">
...
%>
    ...
    <center>
      ...
      <form method="post" action="ppdf_gen2M">
      <button type ="submit" style=  "width: 30%;" >convert pdf</button></form> 
      </center>
</body>
</html>