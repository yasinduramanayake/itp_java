...
%>
<center>
<h1 style="align:center;color:white;"><font><strong>Your Profile</strong></font></h1>
</center>
...
String  sql1= "select * from customer where UID=?";
...
<center>
	...
	<center>
			<table>
				...
				<tr>
					<td><b><div style="height: 50px;color:white; "><%="Your ID : " + res.getString("UID") %></div></b></td>
				</tr>
				<tr>
				...
				<tr>
					<td><b><div style="height: 50px;color:white; "><%="NIC : " + res.getString("NIC") %></div></b></td>
				</tr>
				
				<tr>
				<td><b><div style="height: 50px;color:white; "><%="E-mail : "+ res.getString("Email") %></div></b></td>
				</tr>
				<tr>
				<td><b><div style="height: 50px;color:white; "><%="Phone : " + res.getInt("contactNum") %></div></b></td>
			</tr>
			<tr>
			...
			<td>
			<center>
			<form method="post" action="CusUpdate_pro_semifial">
<input type ="number"  name="uidq" hidden value ="<%=res.getString("UID")%>">
<input type ="text" name="Name" hidden value="<%=res.getString("Name")%>" >
<input type ="text" name="Address" hidden value="<%=res.getString("Address")%>" >
<input type ="number" name="contactNum" hidden value="<%=res.getString("contactNum")%>" >
<input type ="text" name="NIC" hidden value="<%=res.getString("NIC")%>" >
<input type ="text" name="Email" hidden value="<%=res.getString("Email")%>" >
<input type ="password" name="PASSWORD" hidden value="<%=res.getString("PASSWORD")%>" >
<input type ="password" name="retypePASSWORD" hidden value="<%=res.getString("retypePASSWORD")%>" >

<button type="submit">Update</button></form>
 	</center>
 	<center>
 	<form method="post" action="DeleteCustomerDetails"><input type ="number"  name="uid" hidden value ="<%=res.getString("UID")%>">
