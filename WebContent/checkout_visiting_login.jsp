...
<div class="split right">
 ...
 <br><br>
    ...
    <form  method="post" action="checkout_visit_servelet">
                        <div class="container">
  ...
  border-radius: 12px;"><br>
      ...
      <input type="text"   hidden value="<%=request.getAttribute("visname")%>" name="visname" required>
      
       <label for="colour"><b></b></label>
      <input type="text"   hidden  value="<%=request.getAttribute("visNic")%>" name="visNic" required>
      
       <label for="itemname"><b></b></label>
      <input type="text"  name="visEmail" value="<%=request.getAttribute("visEmail")%>" hidden required>
      
        <label for="price"><b></b></label>
      <input type="text"   hidden value="<%=request.getAttribute("vispphone")%>" name="vispphone" required>
      
       <label for="colour"><b></b></label>
      <input type="text"  hidden  value="<%=request.getAttribute("visaddress")%>" name="visaddress" required>
      
       <label for="itemname"><b></b></label>
      <input type="text"  name="vismassage" value="<%=request.getAttribute("vismassage")%>" hidden required>
