...
<li><div class="search"><form method="post" action="hotel_product_search">

<input type="search" name="searchhotelp" id="myInput1" placeholder="Search items.." ><input type="submit" value="search"></form></div></li>
<li>
...
<center><h1 style = "font-family: Arial, Helvetica, sans-serif;
				        color:white;
				        font-size: 2.0em;
				        text-shadow: 3px 2px #black;">Hotel Furnitures</h1></center>
				        <center>
...
<td><form action="preupdated_displayibg_furnitures" method="post">
					    ...
					    <input name="Itemcategory" type = "text" hidden id = "Itemcategory" value="Hotel" placeholder = "Update the Category" required>
						...
						<input type="number"  hidden required name="link" value="1">			
