...
<li><a href="CustomerRetrieve.jsp">Your_Profile</div></a></li>
   ...
   function check()
   {
	...
	<center>
			...
			<form action="updeteVisiteServlet" method="POST">
				
				<h1 >Contac Us</h1>
					<br><br>
						
						<input name="visiteId" hidden type = "number" id = "visiteId" value="<%=request.getAttribute("id")%>" >
					
					
					
						 <label for="uname"><b>Update Name:</b></label><br>
						<input name="fullname"  type = "text" id = "fname" placeholder = "Your Name" value="<%=request.getAttribute("fn")%>" required><br><br>
					
						<label for="uname"><b>Update NIC number:</b></label><br>
						<input name="NIC"  type = "text" id = "NIC" placeholder = "Your NIC" value="<%=request.getAttribute("nic")%>" pattern = "[0-9]{9}[V|v]" required>	<br><br>
					
						<label for="uname"><b>Update Email:</b></label><br>
						<input name="Email" type = "email" id = "email" placeholder = "Your Email" value="<%=request.getAttribute("emil")%>" required><br><br>
					
						<label for="uname"><b>Update Phone Number:</b></label><br>
						<input name="pNum" type = "phone" id = "mNo" placeholder = "Your Phone Number" value="<%=request.getAttribute("pnum")%>" pattern="[0-9]{10}"required><br><br>
					
					<label for="uname"><b>Update Address</b></label><br>
					    
					
						<input name="adres" type="text" id="adress"
							placeholder="update the Address" value="<%=request.getAttribute("addres")%>"
							 required><br><br>
												
					
						<label for="uname"><b>Update Message:</b></label><br>
						

					<input name="message" type="text" id="message"
							placeholder="Messege" value="<%=request.getAttribute("msseg")%>"
							  required><br><br>
						...
						<button type="submit" value="UPDATE" id ="button"class="button" >UPDATE</button>
