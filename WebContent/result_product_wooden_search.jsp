...
<% ArrayList<item_details> searchingproreshotel =(ArrayList<item_details>)request.getAttribute("Arrayprowooden"); %>


<h2 align="center" style="color:white;"><font><strong>Hotel Furnitures</strong></font></h2>
<center>
