...
<br><br><br><br>
<center>
<div class="container" style="background-color:#f1f1f1;width:50%;height:50%;">
<form  method ="post" action="UpdateCustomerDetails">
<h2>Edit Customer Profile</h2>

 <label for="materials"><b>Update Name:</b></label><br><br>
	<input type="text" name="Name" id ="name"placeholder="Name with initials"value="<%=request.getAttribute("cname")%>" required style=" width: 50%;
  padding: 12px 20px;
  margin: 8px 0;
  ...
  border-radius: 12px;"><br><br>
         ...
         <label for="materials"><b>Update Address:</b></label><br><br>
         <input type="text" name="Address" id="Address" placeholder="Address*"value="<%=request.getAttribute("caddress")%>" required style=" width: 50%;
  padding: 12px 20px;
  margin: 8px 0;
  display: inline-block;
  border: 1px solid #ccc;
  ...
  border-radius: 12px;"><br><br>
          ...
          <label for="materials"><b>Update ContactNum:</b></label><br><br>
        <input type="number" name="contactNum" id="contactNum"  placeholder="contact number*" value="<%=request.getAttribute("ccontct")%>" pattern="[0-9]{10}" title="invalid contact number"required style=" width: 50%;
  padding: 12px 20px;
  margin: 8px 0;
  display: inline-block;
  border: 1px solid #ccc;
  ...
  border-radius: 12px;"><br><br>
         ...
         <label for="materials"><b>Update NIC:</b></label><br><br>
         <input type="text" name="NIC" id="Email" placeholder="NIC*"value="<%=request.getAttribute("cnic")%>" pattern = "[0-9]{9}[V|v]" title="invalid NIC number" required  style="width: 50%;
  padding: 12px 20px;
  margin: 8px 0;
  display: inline-block;
  border: 1px solid #ccc;
  ...
  border-radius: 12px;"><br><br>
       ...
       <label for="materials"><b>Update E-mail:</b></label><br><br>
         <input type="email" name="Email" id="Email" placeholder="Email*"value="<%=request.getAttribute("cemail")%>"pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="please enter valid email Address" required style=" width: 50%;
  padding: 12px 20px;
  margin: 8px 0;
  display: inline-block;
  border: 1px solid #ccc;
  ...
  border-radius: 12px;"><br><br>
    ...
    <label for="materials"><b>Update Password:</b></label><br><br>
         <input type="password" name="PASSWORD" id="PASSWORD" placeholder="Password*"value="<%=request.getAttribute("cpassword") %>" title="Password must contain at least 6 characters, including UPPER/lowercase and numbers."pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}"required style=" width: 50%;
  padding: 12px 20px;
  margin: 8px 0;
  display: inline-block;
  border: 1px solid #ccc;
  ...
  border-radius: 12px;"><br><br>
         ...
         <input type="number" hidden name="uidcs" value="<%=request.getAttribute("uidiq")%>">

 <label for="materials"><b>Retype Password:</b></label><br><br>
        <input type="password" name="retypePASSWORD" id="retypePASSWORD" placeholder="Confirm password*"value="<%=request.getAttribute("retypecpass") %>"  title="Please enter the same Password as above."pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}"required style=" width: 50%;
  padding: 12px 20px;
  margin: 8px 0;
  display: inline-block;
  border: 1px solid #ccc;
