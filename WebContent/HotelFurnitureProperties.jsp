...
<li><div class="search"><form method="post" action="Serach_Hotel_servelet">
...
<h2 align="center" style=color:white;><font><strong>Hotel Furniture properties</strong></font></h2>
<center>
...
<td>
  ...
  <form  action="Update_PricingProperties" method="post">
      ...
      <input type="text" name="lab" value="<%=res.getString("labour") %>" hidden placeholder="<%=res.getString("labour") %>"required>
      ...
      <input type="number"step ="0.01" name="labcost" hidden value="<%=res.getDouble("labour_cost") %>" placeholder="<%=res.getDouble("labour_cost") %>" required>                  
       ...
       <input type="text"  name="type" hidden value="Hotel" required>
                       
        <input type="number" step="1"  hidden required name="pid" value="<%=res.getInt("Property_ID") %>">
         <input type="number" hidden name="link" value="1">
