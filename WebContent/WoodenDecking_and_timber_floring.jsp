...
<title>WoodenDecking and timber Floring Furniture Properties</title>
...
<li><div class="search" ><form method="post" action="Woodenfloring_search_servelet">
...
<h2 align="center" style=color:white;><font><strong>Wooden&Decking Furniture properties</strong></font></h2>
<center>
...
<td>
  ...
  <form  action="Update_PricingProperties" method="post">
      ...
      <input type="text"   name="mat"  value="<%=res.getString("material") %>" hidden placeholder="<%=res.getString("material") %>" required>

    
      <input type="text" name="lab"  hidden value="<%=res.getString("labour") %>" placeholder="<%=res.getString("labour") %>"required><br><br>
                        

     <input type="number"step ="0.01" name="labcost" hidden value="<%=res.getDouble("labour_cost") %>" placeholder="<%=res.getDouble("labour_cost") %>" required>                  
       ...
       <input type="text"  name="type" hidden value="Wooden&Decking" required>
                       
        <input type="number" step="1"  hidden required name="pid" value="<%=res.getInt("Property_ID") %>">
         <input type="number" hidden name="link" value="3">
      ...
      <button type="submit">Update</button>
                          ...
                          </form><form method="post" action="Delete_Properties" >
<input type="number" step="1"  hidden required name="Pid" value="<%=res.getInt("Property_ID") %>">
     <input type="number" hidden name="link" value="3">
