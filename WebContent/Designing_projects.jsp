...
<li><div class="search"><form method="post" action="SearchPastproject">

<input type="search" name="searchProjectsall"  id="myInput2" placeholder="Search.." >
...
<center><h1 style = "font-family: Arial, Helvetica, sans-serif;
				        color:white;
				        font-size: 2.0em;
				        text-shadow: 3px 2px #black;">Designing projects</h1></center>
				        <center>
...
<td><form  method="post" action="preupdated_deigning_projects">
            ...
            <input type="number"  step="1"  name="proect_ID" id="Type"  value="<%=res.getString("proect_ID")%>" required hidden>
						...
						<input type="text"  hidden name="Description"  id ="Description" value="<%=res.getString("Description")%>"  required >
			             <input type="number"  step="1" hidden name="linkproject"   value="1"  required >
			...
			<input type="number"  step="1" hidden name="linkproject" type ="text"  value="1"  required >
