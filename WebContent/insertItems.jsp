...
<div class="crt">Cart</div></a></li>
 ...
 <li><a href="visiteDetails.jsp">All_Visitting_requests</a></li>
	...
	<form action="CreateItems" method="POST">
	<h1> Insert
  ...
  border-radius: 12px;" > <input name="myimg"
						type="text" id="itemImageB64" hidden></center><br>
				
					<label for="uname"><b>Select Item Category :</b><br>
				
					<select name="Itemcategory" id="Itemcategory"
						placeholder="Enter the Category" required  style="width: 60%;
  padding: 12px 20px;
  margin: 8px 0;
  display: inline-block;
  border: 1px solid #ccc;
  ...
  border-radius: 12px;">
					        ...
					        <option value="Pantey&Kitchen">Pantey&Kitchen</option>
                            <option value="Sofa">Sofa</option>
                            <option value="Wooden&Decking">Wooden&Decking</option>
					        </select><br><br>
				
					<label for="uname"><b>Enter Item Name :</b><br>
				
					<input name="Itemname" type="text" id="Itemname"
							placeholder="Enter Item Name" required style="width: 60%;
  padding: 12px 20px;
  margin: 8px 0;
  display: inline-block;
  border: 1px solid #ccc;
  ...
  border-radius: 12px;"><br><br>
					...
					<label for="uname"><b>Enter Description :</b><br>
				
					<textarea name="Discription" type="text" id="Discription"
							placeholder="Discription" required style="resize: vertical; width: 60%;
  padding: 12px 20px;
  margin: 8px 0;
  display: inline-block;
  border: 1px solid #ccc;
  ...
  border-radius: 12px;"></textarea><br><br>
					...
					<label for="uname"><b>Enter Price :</b><br>
			
					<input name="Itemprice" type="number" step="0.01" id="Itemprice"
							placeholder="Enter Price" required style="width: 60%;
  padding: 12px 20px;
  margin: 8px 0;
  display: inline-block;
  border: 1px solid #ccc;
