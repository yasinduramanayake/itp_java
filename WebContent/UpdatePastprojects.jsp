 ...
 <li><a href="visiteDetails.jsp">All_Visitting_requests</a></li>
	...
	<center>
     ...
     <div class="container" style="background-color:#f1f1f1;background-color: rgba(255,255,255,0.5); width:50% ;height:50%;">
			...
			<form  method="post" action="PastProjectUpdate">
	...
	<hr style="color:black;">
	  ...
	  <br>
		...
		<input type="number" step="1" hidden name="proect_ID" type ="text" id ="Description" hidden value="<%=request.getAttribute("proid_project")%>" required >
		<input type="text"  hidden name="Type" type ="text"  value="<%=request.getAttribute("Type_Projct")%>" required >
  ...
  border-radius: 12px;" ><br>	<br> <input name="myprojects"
						...
						type="text" id="itemImageB641" value="<%=request.getAttribute("Project_image")%>" hidden ></center>
					
						
						<b>Update Description</b>
						<br><input name="Description" type ="text" id ="Description" value="<%=request.getAttribute("description_project")%>"  required style="width: 60%;
  padding: 12px 20px;
  margin: 8px 0;
  display: inline-block;
  border: 1px solid #ccc;
  ...
  border-radius: 12px;">
					...
					<br><br>
					<input type="number" step="1" hidden name="linkproject" type ="text" id ="Description" value="<%=request.getAttribute("linkproup_project")%>" hidden required >
