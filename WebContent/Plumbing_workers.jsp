...
<input type="search" name="searchhousep" id="myInput8" placeholder="Search.." ><input type="submit" value="search"></form></div></li>
<li>
...
<center><h1 style = "font-family: Arial, Helvetica, sans-serif;
				        color:white;
				        font-size: 2.0em;
				        text-shadow: 3px 2px #black;">Plumbing workers</h1></center>
				        <center>
...
preparedStatement.setString(1,"PLUMBING WORKES");
...
<td><form  method="post" action="preupdated_deigning_projects">
            ...
            <input type="number"  step="1"  name="proect_ID" id="Type"  value="<%=res.getString("proect_ID")%>" required hidden>
						...
						<input type="text"  hidden name="Description"  id ="Description" value="<%=res.getString("Description")%>"  required >
			             <input type="number"  step="1" hidden name="linkproject"   value="5"  required >
			...
			<input type="number"  step="1" hidden name="linkproject" type ="text"  value="5"  required >
