...
<form action="OwnerDisplayPayment.jsp">
<Button style="width:30%;float: left;" type="submit">View Payments</Button>
</form>




<form action="Display_owner_Administrater.jsp">
<Button  style="width:30%;float: right;" type="submit">View Orders</Button>
</form>
