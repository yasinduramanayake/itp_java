 ...
 <li><a href="visiteDetails.jsp">All_Visitting_requests</a></li>
	...
	<center>
     ...
     <div class="container" style="background-color:#f1f1f1;background-color: rgba(255,255,255,0.5); width:50% ;height:50%;">
			...
			<form  method="post" action="Past_project_insert">
	...
	<hr style="color:black;">
	  ...
	  <br>
                                    ...
                                    <label for="uname"><b>Enter project Type: </b></label><br>
					    <select name="Type" id="Type" type ="text"  required style="width: 60%;
  padding: 12px 20px;
  margin: 8px 0;
  ...
  border-radius: 12px;">
					    ...
					    <option>DESIGENING</option>
					    <option>CIVIL CONSTRUCTION WORKES</option>
					    <option>ANY TYPE OF ALUMINUM FABRICATE WORKES </option>
					    <option>ELECTRICAL INSTALLATION WORKES</option>
					    <option>PLUMBING WORKES</option>
					    <option>FLOOR CARPETING AND CURTAIN</option>
					     <option>STEEL AND STAINLESS STELL FABRICATE WORKES</option>
					      <option>FURNITURE AND WOODEN PANELLING / PARTITONING</option>
					      
					    </select><br><br>
					
									<label for="uname"><b>Enter Item Image :</b><br>
				<center><input name="myimg1" type="file" id="itemImage1"
  ...
  border: 1px solid #ccc;
  box-sizing: border-box;
  border-radius: 12px;" ><br>	<br> <input name="myprojects"
						type="text" id="itemImageB641" hidden ></center>
					
						
						<b>Description</b>
						<br><textarea name="Description" type ="text" id ="Description"  required style="width: 60%;
  padding: 12px 20px;
  margin: 8px 0;
  display: inline-block;
  border: 1px solid #ccc;
  ...
  border-radius: 12px;"></textarea>
			...
			<button type="submit" >ADD PROJECT</button><br><br>
