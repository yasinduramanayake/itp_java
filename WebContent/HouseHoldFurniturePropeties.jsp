...
<li><div class="search"><form method="post" action="Search_Household_Servlet">
...
<h2 align="center" style=color:white;><font><strong>House hold Furniture properties</strong></font></h2>
<center>
...
<td>
  ...
  <form  action="Update_PricingProperties" method="post">
     ...
     <input type="number"step ="0.01" hidden  name="labcost" value="<%=res.getDouble("labour_cost") %>" placeholder="<%=res.getDouble("labour_cost") %>" required>                  
       ...
       <input type="text"  name="type" hidden value="HouseHold" required>
                       
        <input type="number" step="1"  hidden required name="pid" value="<%=res.getInt("Property_ID") %>">
         <input type="number" hidden name="link" value="6">
