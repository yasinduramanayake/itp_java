...
<button type="submit"  style="float: right;
 ...
 <li><a  style="background-color: grey;" href="AdminDashboard.jsp">Dashboard</a></li>
  ...
  <button class="dropbtn" style="background-color: grey;  border-radius: 0px;" >Online_Store</button>
  ...
  <li><a style="background-color: grey;" href="pastProjectRetrive.jsp">Company_Projects</a></li>
  <li><a style="background-color: grey;" href="OwnerRetriew.jsp">Owner_Profile</a></li>
   
<li><a style="background-color: grey;" href="cartCutomerRetrive.jsp">
Your_cart</div></a></li>
      
<li><a style="background-color: grey;" href="CustomerRetrieve.jsp">Your_Profile</div></a></li>

<li><div class="search"><form method="post" action="">
...
<li>
	...
	%>
		...
		<div class="product">
				...
				<tr>
					<td><img alt="img" style="width: 250px;" src="<%=res.getString("image")%>" /><br><br></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<input type="number" step="0.01" id="price" name="price" value="<%=res.getDouble("Price")%>" hidden required >
					  color:</br><select name="colours" style="resize: vertical; width: 60%;
  padding: 12px 20px;
  margin: 8px 0;
  ...
  border-radius: 12px;">
                ...
                <d id="f">Quantity :</d></br>
					<input type="number" step="1" id="quantity" min="0.00" placeholder="Enter quantity" required name="quantity" style="resize: vertical; width: 60%;
  padding: 12px 20px;
  margin: 8px 0;
  display: inline-block;
  border: 1px solid #ccc;
