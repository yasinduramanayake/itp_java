...
<div class="split right">
 ...
 <br><br>
    ...
    <form  method="post" action="Checkout_cart_servelet">
                        <div class="container">
  ...
  border-radius: 12px;"><br>
      ...
      <input type="number" step="0.01"  hidden value="<%=request.getAttribute("cartlogpr")%>" name="pricey" required>
      
       <label for="quantity"><b></b></label>
      <input type="number" step="1"  hidden  value="<%=request.getAttribute("cartlogquan")%>" name="quanyy" required>
      
       <label for="color"><b></b></label>
      <input type="text"  name="color12" value="<%=request.getAttribute("cartlogcolo")%>" hidden required>
