...
<title>Pricing Properties</title>
...
<center>
                    ...
                    <form action="Pricing_properties" method="post">
                    
                    
                    
                    <h2>Enter pricing properties.....</h2>
    
<div class="container" style="background-color:#f1f1f1">
    
      <label for="materials"><b>Enter materials:</b></label><br><br>
      <input type="text" id="mat"  name="mat" placeholder="Enter materials" required><br><br>

      <label for="Labours"><b>Enter Labours:</b></label><br><br>
     <input type="text" id="lab" name="lab" min="0.00" placeholder="Enter Labours" required><br><br>
                        
     <label for="Labour cost"><b>Enter Labour cost:</b></label><br><br>
    <input type="number" id="labcost" min="0.00" step ="0.01" name="labcost" placeholder="Enter Labour cost" required><br><br>
        
        <label for="material cost"><b>Enter material cost:</b></label><br><br>
        <input type="number" id="matcost" min="0.00" step ="0.01"  name="matcost" placeholder="Enter material cost" required><br><br>
        
        <label for=" Discount"><b>Enter Discount:</b></label><br><br>
       <input type="number" id="dis" min="0.00" step ="0.01" name="dis" placeholder="Enter Discount" required><br><br>
       
       <b>Select Item-type:</b><br><br>
        ...
        <label for="item-name"><b>Enter item-name:</b></label><br><br>
  ...
  <button type="submit" style="width:30%" onclick="save()">AUTOFILL</button>
  
      <form method="post" action="Pricing_pdf">
      <button type ="submit" style="width:30%">Genarate a pdf</button></form> 
 ...
 <script> 
 function save(){
    document.getElementById('mat').value = 'polish,wakinsh,wire';
    document.getElementById('lab').value = 'carpenter,bass-rent,Drivers';
    document.getElementById('labcost').value = '30000.00';
    document.getElementById('matcost').value = '12000.00';
    document.getElementById('dis').value = '1600.00';
    document.getElementById('name').value = 'chair2020_02';
 }
  </script>
